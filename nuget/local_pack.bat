...
dotnet pack ..\src\SignalW.Client -c DEBUG -o C:\tools\LocalNuget --version-suffix "%build%"

dotnet pack ..\src\SignalW -c DEBUG -o C:\tools\LocalNuget --version-suffix "%build%"
