...
namespace Spreads.SignalW.WebSockets
{
    internal class HttpUpgradeStream : Stream
    {
        ...
        public HttpUpgradeStream(Stream oldHttpUpgradeStream)
        {
            var requestField = oldHttpUpgradeStream.GetType().GetField("_requestStream",
                BindingFlags.NonPublic | BindingFlags.GetField | BindingFlags.Instance);
            _requestStream = (Stream) requestField.GetValue(oldHttpUpgradeStream);

            var responseField = oldHttpUpgradeStream.GetType().GetField("_responseStream",
                BindingFlags.NonPublic | BindingFlags.GetField | BindingFlags.Instance);
            _responseStream = (Stream)responseField.GetValue(oldHttpUpgradeStream);
        }
        ...
        {
            return _requestStream.Read(buffer);
        }
